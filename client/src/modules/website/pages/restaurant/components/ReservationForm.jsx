...
const FALLBACK = {
  ...
  header2: "Table.",
  description:
    "A curated dining experience awaits. Reserve your space in our premier destination.",
...
export default function ReservationForm({ propertyId }) {
  // step 1 = details form, step 2 = confirm, step 3 = thank you
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <motion.div style={{ y: smoothFormY }} className="lg:w-2/3 w-full">
            <div className="bg-white/40 dark:bg-zinc-900/40 backdrop-blur-2xl border border-zinc-200 dark:border-white/10 p-8 md:p-12 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] dark:shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] relative overflow-hidden rounded-3xl">
              {/* Progress bar — 2 steps (hide on thank you) */}
              {currentStep < 3 && (
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        <h3 className="text-zinc-900 dark:text-white font-serif text-3xl">
                          Request{" "}
                          <span className="italic text-primary">Received!</span>
                        </h3>
              ...
              {/* Step number overlay — hidden on thank you */}
              {currentStep < 3 && (
