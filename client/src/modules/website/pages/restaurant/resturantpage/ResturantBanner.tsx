  ...
  if (loading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-muted-foreground animate-pulse">Setting the table...</p>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 mb-8">
          <motion.div variants={staggerContainer} className="space-y-3 w-full">
            ...
            <motion.h1 variants={fadeIn} className="text-4xl md:text-5xl font-serif font-bold tracking-tight text-balance">
              {restaurant.name}
            </motion.h1>
            ...
            <motion.div variants={fadeIn} className="flex flex-wrap items-center gap-y-2 gap-x-6 text-muted-foreground">
              <div className="flex items-center gap-1.5 group cursor-default">
                ...
                <span className="text-sm font-medium">{restaurant.location}, {restaurant.city}</span>
              </div>
          ...
          <motion.div variants={fadeIn} className="flex gap-3">
            ...
            >
              <Heart className="w-4 h-4 mr-2 group-hover:fill-destructive group-hover:text-destructive transition-colors" /> Save
            </Button>
          </motion.div>
        </div>
