...
const BEST_SELLERS = [
  ...
  },
  {
    ...
    description:
      "Velvet milk foam layered over a structured espresso pull for a balanced Wine classic.",
  ...
  },
  {
    ...
    description:
      "Blended coffee, cream, and caramel in a thicker frozen profile made for long Wine hours.",
    image: siteContent.images.cafes.highTea.src,
    tags: ["Cold Brews", "Best Seller"],
          ...
          <div className="min-w-0 flex-1 lg:max-w-[80%]">
            ...
            <div className="max-w-[80%]">
              <p className="text-sm font-light leading-relaxed text-zinc-500">
                ...
                but tuned for Wine categories, coffee language, and brew-led
                highlights.
              </p>
            </div>
          </div>
