...
const STORY_CARDS = [
  {
    ...
    description:
      "Kennedia Wine started as a single roastery counter in 2018, driven by a belief that good coffee and calm spaces could transform any ordinary day into something worth remembering.",
  ...
  },
  {
    ...
    description:
      "Our bakery team starts at 5 AM every day. By the time the Wine opens, every croissant, sourdough loaf, and pastry is fresh out of the oven because we think that matters.",
  ...
  },
  {
    ...
    title: "A Wine That Grows With Its Guests",
    description:
      "We run workshops, cupping sessions, and monthly brunch pop-ups because the best Wines are not just places to drink coffee. They are places where regulars become regulars for a reason.",
...
export default function WineSubCategories() {
        ...
        <div className="grid w-full min-h-[58vh] items-stretch grid-cols-[1.3fr_0.7fr] gap-16 px-12 xl:px-24">
          ...
          <div className="flex h-full flex-col justify-center">
            ...
            <h2 className="mb-8 text-5xl xl:text-6xl font-serif leading-[1.1] text-zinc-950 dark:text-white">
              Six Chapters <br />
              <span className="italic text-amber-800">One Wine</span>
            </h2>
      ...
      <div className="w-full px-6 lg:hidden">
        <div className="mb-14">
          ...
          <h2 className="mb-6 text-4xl font-serif text-zinc-950 dark:text-white">
            Six Chapters, <span className="italic text-amber-800">One Wine</span>
          </h2>
