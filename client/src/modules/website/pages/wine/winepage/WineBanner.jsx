...
export default function WineBanner() {
  ...
  const companions  = [
    Wine_GALLERY_MEDIA[(activeThumb + 1) % totalImages],
    Wine_GALLERY_MEDIA[(activeThumb + 2) % totalImages],
  ];
          ...
          <div className="flex flex-col shrink-0">
            ...
            >
              <div className="flex items-center gap-1.5 text-xs font-medium text-[#7a5c3a] dark:text-[#a07850]">
                ...
                <span className="truncate max-w-[220px]">{Wine_DATA.location}</span>
              </div>
              <a
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 pointer-events-none z-10">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className="text-white/70 text-[9px] font-medium">{Wine_DATA.city}</span>
                  </div>
                </div>
