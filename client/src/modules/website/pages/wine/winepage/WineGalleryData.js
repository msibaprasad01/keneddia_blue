...
export const Wine_GALLERY_ITEMS = [
  {
    id: 1,
    category: "INTERIOR",
    categoryName: "INTERIOR",
    propertyId: 1,
    propertyName: "Kennedia Wine",
    isActive: true,
    media: {
      mediaId: 1,
      type: "IMAGE",
      url: siteContent.images.cafes.parisian.src,
      fileName: "Parisian Wine Interior",
      alt: "Parisian Wine Interior",
      width: null,
      height: null,
    },
  },
...
export const Wine_GALLERY_MEDIA = Wine_GALLERY_ITEMS.map((item) => item.media);
