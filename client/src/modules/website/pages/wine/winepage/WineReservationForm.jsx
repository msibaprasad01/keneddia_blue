...
const FALLBACK = {
  ...
  header2: "Wine Table.",
  description:
    "Set your time, confirm the details, and let the Wine experience be ready when you arrive.",
...
export default function WineReservationForm() {
  ...
  return (
    ...
    >
      ...
      >
        Wine Reservations Table Booking Experience
      </motion.div>
