          ...
          <div className="grid grid-cols-1 lg:grid-cols-[60%_38%] gap-4 lg:gap-6">
            ...
            <div className="relative h-[320px] md:h-[400px] lg:h-[480px] rounded-xl lg:rounded-2xl overflow-hidden shadow-xl lg:shadow-2xl">
              {filteredProperties.map((property, index) => (
                <div
                  key={property.id}
                  className={`absolute inset-0 transition-all duration-1000 ease-in-out ${index === activeIndex ? "opacity-100 translate-x-0" : "opacity-0"}`}
                >
                  <OptimizedImage
                    ...
                    <div className="w-full px-4 md:px-8 lg:px-12">
                      <div className="max-w-xl">
                        <button
                          ...
                          className="mb-4 p-2 rounded-full bg-white/10 backdrop-blur-md text-white hover:bg-white/20 transition-all border border-white/20 flex items-center gap-2 group"
                        >
                        ...
                        <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
                          {filteredProperties.map((_, idx) => (
                            ...
                            >
                              ...
                              <div
                                className={`h-0.5 transition-all duration-500 ${idx === activeIndex ? "w-8 md:w-12 bg-white" : "w-6 md:w-8 bg-white/30"}`}
                              />
                            </div>
                          ))}
                        </div>
              ...
              <div className="bg-card border border-border rounded-xl lg:rounded-2xl p-4 md:p-5 lg:p-6 shadow-lg h-fit">
                ...
                <div className="pt-5">
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button className="py-2 border border-border text-foreground font-semibold rounded-lg hover:border-primary transition-all flex items-center justify-center gap-1 text-xs">
                        <Phone size={14} /> Call
                      </button>
                      <button className="py-2 border border-border text-foreground font-semibold rounded-lg hover:border-primary transition-all flex items-center justify-center gap-1 text-xs">
                        <Mail size={14} /> Email
