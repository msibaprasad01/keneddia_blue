...
function GuestExp() {
  ...
  const handleModalSubmit = async () => {
    ...
    try {
      ...
      toast.success(headerData ? "Header updated successfully" : "Header saved successfully");
      await fetchHeader();
      closeModal();
    } catch (error) {
      ...
      >
        ...
        {headerFetching ? (
          <div className="flex items-center gap-2 py-2">
            ...
            <span className="text-xs" style={{ color: colors.textSecondary }}>Loading header...</span>
          </div>
        ) : headerData ? (
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <div>
                <p className="text-[10px] uppercase font-semibold tracking-wide" style={{ color: colors.textSecondary }}>
                  Section Tag
                </p>
          ...
          <p className="text-xs py-2" style={{ color: colors.textSecondary }}>
            No header configured yet. Click <strong>Add Header</strong> to set one.
          </p>
        )}
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr style={{ backgroundColor: colors.mainBg }}>
                ...
                <th className="p-4 text-xs font-semibold uppercase" style={{ color: colors.textSecondary }}>Added On</th>
            ...
            <tbody className="divide-y" style={{ divideColor: colors.border }}>
              {fetching ? (
                ...
                <tr>
                  <td colSpan="5" className="p-10 text-center text-sm" style={{ color: colors.textSecondary }}>
                  ...
                  return (
                    <tr key={exp.id} className="hover:bg-black/5 transition-colors">
                      ...
                      <td className="p-4">
                        ...
                        <div className="text-xs line-clamp-1 max-w-[300px]" style={{ color: colors.textSecondary }}>{exp.description}</div>
                      </td>
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-sm font-medium" style={{ color: colors.textPrimary }}>{date}</span>
                        </div>
                        <div className="text-[10px] mt-0.5 pl-[18px]" style={{ color: colors.textSecondary }}>{time}</div>
                      </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            >
              ...
              >
                {modalLoading ? <Loader2 size={14} className="animate-spin" /> : <Pencil size={14} />}
