      ...
      <div className="container mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <Link href="/">
              <a
                ...
                className="text-secondary-foreground font-light text-3xl tracking-[0.2em] uppercase hover:text-accent transition-colors inline-block"
            ...
            <div className="flex items-center gap-4 pt-4 border-t border-white/10">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 flex items-center justify-center text-secondary-foreground/80 hover:text-accent transition-colors"
                >
          ...
          {footerSections.map((section, index) => (
            <div key={index}>
              <h3 className="text-secondary-foreground font-semibold text-sm mb-6 uppercase tracking-wider">
                {section.title}
              </h3>
                ...
                {section.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    <Link href={link.href}>
                      <a
                        onClick={handleLinkClick}
                        className="text-sm text-secondary-foreground/80 hover:text-accent transition-colors block"
                      >
                        {link.label}
                      </a>
                    </Link>
